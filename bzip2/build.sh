...
install()
{
    ...
    ${GINSTALL} -m 755 libbz2.so.1.0.2 ${stagedir}${prefix}/${_libdir}
    ...
    ${LN} -s libbz2.so.1.0.2 ${stagedir}${prefix}/${_libdir}/libbz2.so.1.0
    ${LN} -s libbz2.so.1.0 ${stagedir}${prefix}/${_libdir}/libbz2.so
