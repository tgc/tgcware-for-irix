...
patch[0]=git-1.7.9.3-trio.patch
patch[1]=git-1.7.2.3-symlinks.patch
patch[2]=git-1.7.4.1-shut_wr.patch
patch[3]=git-1.7.9.3-inet_addrstrlen.patch

# Source function library
. ${BUILDPKG_SCRIPTS}/buildpkg.functions

# Use GNU strip
__strip=/usr/tgcware/mips-sgi-${os}/bin/strip
strip_elf_args="-g"
...
install()
{
    ...
    ${__tar} -xzf $(get_source_absfilename "${source[1]}")
